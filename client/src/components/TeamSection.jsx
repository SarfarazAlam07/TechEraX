...
const TeamSection = () => {
  const { members } = useData(); // ✅ Use API Data
  ...
  return (
    <div className="w-full bg-[#0a0a1a] flex flex-col items-center justify-start md:justify-center pt-8 pb-6 md:min-h-screen md:py-12 font-sans overflow-hidden relative">
      ...
      >
        <h2
          id="ourTeam"
          className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-pink-600 mb-3"
        >
          Our Team
        </h2>
      ...
      <motion.div
        className="w-full px-8 pb-4 relative z-10 flex gap-6 overflow-x-auto snap-x snap-mandatory scroll-smooth md:grid md:grid-cols-2 lg:grid-cols-4 md:w-auto md:overflow-visible md:justify-center scrollbar-hide"
        initial="hidden"
        whileInView="visible"
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 h-full w-full rounded-2xl bg-slate-900/60 backdrop-blur-xl border border-white/10 shadow-inner p-6 text-slate-200 [transform:rotateY(180deg)] [backface-visibility:hidden] flex flex-col items-start">
          ...
          <p className="text-sm text-gray-300 leading-relaxed line-clamp-3 mb-auto">
            {member.description}
          </p>
            ...
            <div className="flex gap-3">
              {member.socials?.twitter && (
                <a
                  ...
                  className="p-2 rounded-full bg-white/10 hover:bg-cyan-500 text-white transition-all"
                >
                  <FaTwitter size={16} />
                </a>
              )}
              {member.socials?.linkedin && (
                <a
                  ...
                  className="p-2 rounded-full bg-white/10 hover:bg-blue-700 text-white transition-all"
                >
                  <FaLinkedin size={16} />
                </a>
              )}
              {member.socials?.github && (
                <a
                  ...
                  className="p-2 rounded-full bg-white/10 hover:bg-gray-600 text-white transition-all"
                >
                  <FaGithub size={16} />
                </a>
              )}
              {member.socials?.instagram && (
                <a
                  ...
                  className="p-2 rounded-full bg-white/10 hover:bg-pink-600 text-white transition-all"
                >
                  <FaInstagram size={16} />
                </a>
              )}
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gradient-to-r from-cyan-600 to-blue-700 rounded-xl text-white font-semibold hover:from-cyan-500 hover:to-blue-600 transition-all shadow-lg active:scale-95 text-sm mt-3"
          >
